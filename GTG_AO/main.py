...
# Robot dynamics, graphics, and GTG+AO+motor controllers.
    ...
    if running:
        ...
        for j in range(0, physics_updates_per_frame_update*frame_skip):
            if (j % physics_updates_per_controller_update == 0):
                ...
                V_r, V_l = controller.update(robot.omega_l, robot.omega_r, robot.heading, robot.x, robot.y, target[0], target[1], closest_points)
