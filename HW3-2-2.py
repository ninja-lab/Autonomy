...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 28 10:39:41 2024
...
class PIDF: 
    def __init__ (self, Kp=1, Ki=1, Kd=1, Tf=.1, Tc=0.01, initial_condition=0): 
        self.Kp = Kp 
        self.Ki = Ki 
        self.Tc = Tc 
        self.Kd = Kd 
    ...
    def update(self, r, y): 
        ...
        self.ud = max( min (self.ud, 1000), -1000)
        self.e_previous = error
        return self.Kp*error + self.Ki*self.integrator_state + self.Kd*self.ud


controller = PIDF(Kp=Kp, Ki=Ki, Kd=Kd, Tf=Tf, Tc=Tc) 
